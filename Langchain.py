...
from llama_index.core.memory.chat_summary_memory_buffer import SUMMARIZE_PROMPT
...
SUMMARIZE_PROMPT = [SystemMessage(content="Summarize the given dialogue between a student and AI. Keep it short, direct and clear")]
...
while True:
    ...
    if (sym in str(ai_response)):
        ...
        print("бот зашел на стадию цензуры")
    ...
    #ввести асинхронный def
    #Очистка памяти
    if len(BASE_SYSTEM_PROMPT) > 10:
        """необходимо протестировать"""
        # a = SUMMARIZE_PROMPT
        # a.append(BASE_SYSTEM_PROMPT[1:5])
        # ai_summarization = llm.invoke(a)
        # b = [str(ai_summarization.content)]
        # BASE_SYSTEM_PROMPT = [BASE_SYSTEM_PROMPT[0]] +b+ [BASE_SYSTEM_PROMPT[5:10]]
